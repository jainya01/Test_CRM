...
function Settings() {
  ...
  return (
    <>
      <title>Settings & Admin Management | CRM Portal</title>
      <meta
        name="description"
        content="Manage CRM settings, create admin accounts, update credentials, reset passwords, and control secure account access in the CRM Settings Portal."
      />

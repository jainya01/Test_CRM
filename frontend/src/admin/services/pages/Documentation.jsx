...
const documentFinalization = [
  {
    passenger: "Ali Hassan",
    passport: "AB1000455",
    type: "Document Finalisation",
    date: "20 Jul 2026",
    status: "Requested",
  },
];
...
function Documentation() {
  ...
  const requestsMap = {
    ...
    5: documentFinalization,
    6: documentTranslation,
    7: fileSubmission,
  };
          ...
          <div className="d-flex justify-content-between">
            ...
            <div>
              ...
              <p className="text-muted overview-lead fw-bold">
                Track checklist, verification, processing, translation &
                submission
              </p>
            </div>
          </div>
        ...
        {reschedule.open && (
          <>
            <div className="modal-overlay">
              ...
              >
                <div className="d-flex justify-content-between">
                  <h5 className="fw-bold">New Documentation Case</h5>
                  <div>
                    <FontAwesomeIcon
                      icon={faX}
                ...
                <div className="row mt-3">
                  ...
                  <div className="col-md-6 mb-1">
                    ...
                    >
                      ...
                      <option value="Document Finalisation">
        ...
        <div className="row g-2 mb-2">
          ...
          <div className="col-lg-3 col-sm-6 col-md-6 col-12">
            <div
              ...
              onClick={() => {
                setActiveCard(2);
                setTableTitle("Checklist Creation");
              }}
            >
              <div className="d-flex flex-column">
                <span className="locations-span">Checklist Creation</span>
                <span className="mt-2">{checklistCreation.length}</span>
                <span className="requests-span">cases</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-sm-6 col-md-6 col-12">
            <div
              ...
              onClick={() => {
                setActiveCard(3);
                setTableTitle("Document Verification");
              }}
            >
              <div className="d-flex flex-column">
                <span className="locations-span">Document Verification</span>
                <span className="mt-2">{documentVerification.length}</span>
                <span className="requests-span">cases</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-sm-6 col-md-6 col-12">
            <div
              ...
              onClick={() => {
                setActiveCard(4);
                setTableTitle("Document Processing");
              }}
            >
              <div className="d-flex flex-column">
                <span className="locations-span">Document Processing</span>
                <span className="mt-2">{documentProcessing.length}</span>
                <span className="requests-span">cases</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-sm-6 col-md-6 col-12">
            <div
              ...
              onClick={() => {
                setActiveCard(5);
                setTableTitle("Document Finalisation");
              }}
            >
              <div className="d-flex flex-column">
                <span className="locations-span">Document Finalisation</span>
                <span className="mt-2">{documentFinalization.length}</span>
                <span className="requests-span">cases</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-sm-6 col-md-6 col-12">
            <div
              ...
              onClick={() => {
                setActiveCard(6);
                setTableTitle("Document Translation");
              }}
            >
              <div className="d-flex flex-column">
                <span className="locations-span">Document Translation</span>
                <span className="mt-2">{documentTranslation.length}</span>
                <span className="requests-span">cases</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-sm-6 col-md-6 col-12">
            <div
              ...
              onClick={() => {
                setActiveCard(7);
                setTableTitle("File Submission");
              }}
            >
              <div className="d-flex flex-column">
                <span className="locations-span">File Submission</span>
                <span className="mt-2">{fileSubmission.length}</span>
                <span className="requests-span">cases</span>
              </div>
            </div>
          </div>

...
function StaffPackage() {
  ...
  return (
    <>
      <title>Travel Packages | CRM Staff Portal</title>
      <meta
        name="description"
        content="Browse travel packages, view package details, pricing, availability, and assist customers with Hajj, Umrah, Ticket, and Medical Visa bookings."
      />

...
const AgentLogin = () => {
  ...
  return (
    <>
      <title>B2B Agent Login | CRM Agent Portal</title>
      <meta
        name="description"
        content="Secure login for B2B agents to manage leads, customer bookings, service requests, commissions, and business operations through the CRM Agent Portal."
      />

...
const AdminLogin = () => {
  ...
  return (
    <>
      <title>Admin Login | CRM Management Portal</title>
      <meta
        name="description"
        content="Secure admin login to the CRM Management Portal. Manage users, customers, services, bookings, reports, and business operations from a centralized dashboard."
      />
